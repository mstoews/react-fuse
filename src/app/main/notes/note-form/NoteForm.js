...
import NoteModel from 'app/main/notes/model/NoteModel';
import NoteLabel from 'app/main/notes/NoteLabel';
import NoteReminderLabel from 'app/main/notes/NoteReminderLabel';
...
function NoteForm(props) {
  ...
  return (
    <div className="flex flex-col w-full">
        ...
        <div className="w-full">
            ...
            render={({ field: { onChange, value } }) => {
              ...
              return (
                <div className="relative">
                  <img src={value} className="block w-full" alt="note" />
                  <Fab
          ...
          {(noteForm.labels || noteForm.reminder || noteForm.time) && (
            <div className="flex flex-wrap w-full px-20 my-16 -mx-4">
              ...
              {noteForm.time && (
                <Typography color="textSecondary" className="mx-4 mt-8 text-12">
      ...
      <div className="flex items-center justify-between flex-auto px-16 pb-12">
          ...
          {props.variant === 'new' ? (
            ...
            <>
              <Tooltip title="Delete Note" placement="bottom">
                <IconButton className="w-32 h-32 p-0 mx-4" onClick={props.onRemove} size="large">
                  <Icon fontSize="small">delete</Icon>
                </IconButton>
              </Tooltip>
